...
const SUPPORT = [
  ...
  ['Inline and block code', 'Rendered inline', 'Fenced and indented blocks remain editable source.'],
  ...
  ['Block quotes and lists', 'Source-aware', 'Markers are themed; nesting and source indentation are preserved.'],
  ['Task lists', 'Interactive source', 'Lowercase and uppercase checked markers toggle as one undo step.'],
  ['Thematic breaks', 'Source-aware', 'The marker is themed but remains visible source.'],
