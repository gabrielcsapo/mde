...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "MDEPluginKit", dependencies: ["MDECore"]),
        .target(name: "MDEditorUI", dependencies: ["MDECore", "MDEPluginKit"]),
        ...
        .target(name: "MDEHost", dependencies: ["MDECore", "MDEPluginKit", "MDEditorUI"]),
        ...
        .testTarget(
            ...
            dependencies: ["MDEPluginKit", "MDEditorUI", "MDEHost"],
